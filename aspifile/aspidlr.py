...
with open('./aspifile/data_datedlr.json', 'a+') as datafile:
...
with open('./aspifile/data_dlr.json', 'a+') as datafile:
...
os.system('./aspifile/plot/plot_dlr.py')

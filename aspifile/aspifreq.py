...
with open('./aspifile/data_datefr.json', 'a+') as datafile:
...
with open('./aspifile/data_fr.json', 'a+') as datafile:
...
os.system('./aspifile/plot/plot_freq.py')

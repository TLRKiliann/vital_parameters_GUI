...
gui.geometry('650x520')

labelTitle = Label(gui, text="Paramètres vitaux :", font=('Times', 18), bg='gray30', fg='snow')
labelTitle.grid(row=0, column=2)

label = Label(gui)
label = Label(text='Entrer la Date :', font=('Times', 14), fg='aquamarine', bg='gray30', width=15)
...
name_text.set("Nom du patient 1")
...
button2Write.config(text='Quitter', width=15, bg='gray40', fg='white',
...
buttonWrite.config(text='Saisir les données', width=15, bg='gray40', fg='aquamarine',
    activebackground='dark turquoise', activeforeground='white', command=writeData)
buttonWrite.grid(row=2, column=3)

buttonDel = Button(gui)
buttonDel.config(text='Réinitialiser Main.json', width=15, bg='coral', fg='yellow',
...
button1Del.config(text='Réinitialiser TA', width=15, bg='coral', fg='yellow',
    activeforeground='blue2', command=delFile)
button1Del.grid(row=3, column=4)

button2Del = Button(gui)
button2Del.config(text='Réinitialiser Puls', width=15, bg='coral', fg='yellow',
    activeforeground='blue2', command=delPuls)
button2Del.grid(row=4, column=4)

button3Del = Button(gui)
button3Del.config(text='Réinitialiser SaO2', width=15, bg='coral', fg='yellow',
    activeforeground='blue2', command=delSat)
button3Del.grid(row=5, column=4)

button4Del = Button(gui)
button4Del.config(text='Réinitialiser FR', width=15, bg='coral', fg='yellow',
    activeforeground='blue2', command=delFreq)
button4Del.grid(row=6, column=4)

button5Del = Button(gui)
button5Del.config(text='Réinitialiser T°C', width=15, bg='coral', fg='yellow',
    activeforeground='blue2', command=delTemp)
button5Del.grid(row=7, column=4)

button6Del = Button(gui)
button6Del.config(text='Réinitialiser Hgt', width=15, bg='coral', fg='yellow',
    activeforeground='blue2', command=delGly)
button6Del.grid(row=8, column=4)

button7Del = Button(gui)
button7Del.config(text='Réinitialiser Dlrs', width=15, bg='coral', fg='yellow',
